...
class TopDown_2Head_Neck(BasePose):
    ...
    def forward(self,
        ...
        """
        if return_loss:
            return self.forward_train(img, target, target_weight, target_reg, target_weight_reg,img_metas,
                                      **kwargs)
        return self.forward_test(
            img, img_metas, return_heatmap=return_heatmap, **kwargs)

    def forward_train(self, img, target, target_weight, target_reg, target_weight_reg,img_metas, **kwargs):
